...
{
    window = new SyscoinGUI(m_node, platformStyle, networkStyle, 0);
...
void SyscoinApplication::addWallet(WalletModel* walletModel)
{
#ifdef ENABLE_WALLET
...
void SyscoinApplication::removeWallet()
{
#ifdef ENABLE_WALLET
